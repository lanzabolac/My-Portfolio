...
@section('content')
    <div id="home" class="home-container reveal">
    ...
    <div id="about" class="about-container reveal">
    ...
    <p class="section-title">
        <span class="light">TECH</span><span class="bold">STACK</span>
    </p>
        ...
        <div class="tech-boxes">
            <div class="tech-box">
                <span class="tech-icon">
                    <span class="icon-default">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"><g clip-path="url(#a)"><path fill="#838383" d="M94.7 29.3c0-1.7-.4-3.2-1.1-4.4-.7-1.3-1.8-2.3-3.2-3.1C78.6 15 66.8 8.2 55 1.3c-3.2-1.8-6.3-1.8-9.4.1-4.7 2.8-28.2 16.3-35.3 20.3C7.4 23.4 6 26 6 29.3v41.1c0 1.6.3 3.1 1 4.3.7 1.3 1.8 2.4 3.3 3.2 7 4.1 30.6 17.5 35.3 20.3 3.2 1.9 6.2 1.9 9.4.1C66.8 91.6 78.6 84.8 90.4 78c1.5-.8 2.5-1.9 3.3-3.2.7-1.3 1-2.7 1-4.3z"/><path fill="#3e3e3e" d="M50.5 49.7 7 74.8c.7 1.3 1.8 2.4 3.3 3.2 7 4.1 30.6 17.5 35.3 20.3 3.2 1.9 6.2 1.9 9.4.1L90.4 78c1.5-.8 2.5-1.9 3.3-3.2z"/><path fill="#3e3e3e" d="M37.6 57.1c2.5 4.4 7.3 7.4 12.7 7.4 5.5 0 10.3-3 12.8-7.5l-12.7-7.3z"/><path fill="#4c4c4c" d="M94.7 29.3c0-1.7-.4-3.2-1.1-4.4L50.5 49.7l43.2 25c.7-1.3 1-2.7 1-4.3z"/><path fill="#fff" d="M92.4 51.5H89v3.4h-3.4v-3.4h-3.4v-3.4h3.4v-3.4H89v3.4h3.4zm-12.4 0h-3.4v3.4h-3.4v-3.4h-3.4v-3.4h3.4v-3.4h3.4v3.4H80z"/><path fill="#fff" d="M63.2 57.1c-2.5 4.5-7.3 7.5-12.8 7.5s-10.2-3-12.7-7.4c-1.3-2.2-1.9-4.7-1.9-7.3 0-8.1 6.6-14.7 14.7-14.7 5.4 0 10.1 2.9 12.7 7.3L76 35.1c-5.1-8.8-14.6-14.7-25.5-14.7C34.2 20.4 21 33.6 21 49.9c0 5.3 1.4 10.3 3.9 14.7 5.1 8.8 14.6 14.8 25.6 14.8s20.5-6 25.6-14.9z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h100v100H0z"/></clipPath></defs></svg>
                    </span>
            ...
            <div class="tech-box">
                <span class="tech-icon">
                    ...
                    <span class="icon-hover">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"><path fill="#264de4" d="m94.175 0-8.033 89.99L50.034 100l-36.01-9.996L6 0z"/><path fill="#2965f1" d="m79.265 84.26 6.865-76.9H50.088v84.988z"/><path fill="#ebebeb" d="m24.396 40.74.99 11.039h24.702V40.74zm25.692-22.342h-27.68l1.003 11.038h26.676zm0 62.495V69.408l-.049.013-12.294-3.32-.786-8.803H25.878l1.547 17.332 22.612 6.277z"/><path fill="#fff" d="m63.642 51.779-1.281 14.316-12.312 3.323v11.484l22.63-6.272.166-1.865 2.594-29.06.27-2.965L77.7 18.398H50.05v11.038h15.555L64.599 40.74H50.05v11.04z"/></svg>
                    </span>
                </span>
                CSS
            </div>
            ...
            <div class="tech-box">
                <span class="tech-icon">
                    <span class="icon-default">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"><path fill="#8c8c8c" d="M33.3 100c9.2 0 16.7-7.5 16.7-16.7V66.7H33.3c-9.2 0-16.7 7.5-16.7 16.7S24.1 100 33.3 100"/><path fill="#818181" d="M16.7 50c0-9.2 7.5-16.7 16.7-16.7H50v33.3H33.3c-9.2.1-16.6-7.4-16.6-16.6"/><path fill="#7a7a7a" d="M16.7 16.7C16.7 7.5 24.1 0 33.3 0H50v33.3H33.3c-9.2 0-16.6-7.4-16.6-16.6"/><path fill="#9b9b9b" d="M50 0h16.7c9.2 0 16.7 7.5 16.7 16.7s-7.5 16.7-16.7 16.7H50z"/><path fill="#939393" d="M83.3 50c0 9.2-7.5 16.7-16.7 16.7S50 59.2 50 50s7.5-16.7 16.7-16.7S83.3 40.8 83.3 50"/></svg>                    <!-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"><g clip-path="url(#a)"><path fill="#0acf83" d="M33.333 100C42.533 100 50 92.533 50 83.333V66.667H33.333c-9.2 0-16.666 7.466-16.666 16.666S24.133 100 33.333 100"/><path fill="#a259ff" d="M16.667 50c0-9.2 7.466-16.667 16.666-16.667H50v33.334H33.333c-9.2 0-16.666-7.467-16.666-16.667"/><path fill="#f24e1e" d="M16.667 16.667C16.667 7.467 24.133 0 33.333 0H50v33.333H33.333c-9.2 0-16.666-7.466-16.666-16.666"/><path fill="#ff7262" d="M50 0h16.667c9.2 0 16.666 7.467 16.666 16.667s-7.466 16.666-16.666 16.666H50z"/><path fill="#1abcfe" d="M83.333 50c0 9.2-7.466 16.667-16.666 16.667S50 59.2 50 50s7.467-16.667 16.667-16.667S83.333 40.8 83.333 50"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h100v100H0z"/></clipPath></defs></svg>    -->
                    </span>
                    <span class="icon-hover">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"><g clip-path="url(#a)"><path fill="#0acf83" d="M33.333 100C42.533 100 50 92.533 50 83.333V66.667H33.333c-9.2 0-16.666 7.466-16.666 16.666S24.133 100 33.333 100"/><path fill="#a259ff" d="M16.667 50c0-9.2 7.466-16.667 16.666-16.667H50v33.334H33.333c-9.2 0-16.666-7.467-16.666-16.667"/><path fill="#f24e1e" d="M16.667 16.667C16.667 7.467 24.133 0 33.333 0H50v33.333H33.333c-9.2 0-16.666-7.466-16.666-16.666"/><path fill="#ff7262" d="M50 0h16.667c9.2 0 16.666 7.467 16.666 16.667s-7.466 16.666-16.666 16.666H50z"/><path fill="#1abcfe" d="M83.333 50c0 9.2-7.466 16.667-16.666 16.667S50 59.2 50 50s7.467-16.667 16.667-16.667S83.333 40.8 83.333 50"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h100v100H0z"/></clipPath></defs></svg>
                    </span>
                </span>
                Figma
            </div>
            <div class="tech-box">
                <span class="tech-icon">
                    ...
                    <span class="icon-default">
                        ...
                        <path fill="#fff" d="M71.6 60.3c-.4 0-.8.3-1.2 1.1-4.2 8.6-11.6 14.7-20.1 14.7-9.9 0-16-8.9-16-21.2C34.3 34.1 45.9 22 56.1 22c4.8 0 7.7 3 7.7 7.8 0 5.7-3.2 8.6-3.2 10.6 0 .9.6 1.4 1.7 1.4 4.4 0 9.6-5.1 9.6-12.3 0-7-6.1-12.1-16.3-12.1-16.8 0-31.8 15.6-31.8 37.2 0 16.7 9.6 27.8 24.3 27.8 15.6 0 24.7-15.6 24.7-20.6 0-1-.6-1.5-1.2-1.5"/>
                        </svg>
                    </span>
                    <span class="icon-hover">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                        ...
                        <!-- Canva script shape -->
                        <path fill="#ffffff" d="M71.6 60.3c-.4 0-.8.3-1.2 1.1-4.2 8.6-11.6 14.7-20.1 14.7-9.9 0-16-8.9-16-21.2C34.3 34.1 45.9 22 56.1 22c4.8 0 7.7 3 7.7 7.8 0 5.7-3.2 8.6-3.2 10.6 0 .9.6 1.4 1.7 1.4 4.4 0 9.6-5.1 9.6-12.3 0-7-6.1-12.1-16.3-12.1-16.8 0-31.8 15.6-31.8 37.2 0 16.7 9.6 27.8 24.3 27.8 15.6 0 24.7-15.6 24.7-20.6 0-1-.6-1.5-1.2-1.5"/>
            ...
            <div class="tech-box">
                <span class="tech-icon">
                    <span class="icon-default">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"><path fill="#6b6b6b" d="M98.5 22.5c0 .1.1.3.1.4v21.3c0 .3-.1.5-.2.8q-.15.3-.6.6L79.9 55.9v20.4c0 .6-.3 1.1-.8 1.3L41.7 99.2c-.1 0-.2.1-.3.1h-.1c-.3.1-.5.1-.8 0 0 0-.1 0-.1-.1-.1 0-.2-.1-.3-.1L2.8 77.7q-.3-.15-.6-.6c-.1-.2-.2-.5-.2-.8v-64c0-.1 0-.3.1-.4 0 0 0-.1.1-.1 0-.1.1-.2.1-.2 0-.1.1-.1.1-.1 0-.1.1-.1.1-.2 0 0 .1-.1.2-.1s.1-.1.2-.1L21.5.2c.2-.1.5-.2.7-.2.3 0 .5.1.8.2L41.7 11c.1 0 .1.1.2.1s.1.1.2.1c.1.1.1.1.1.2l.1.1c0 .1.1.2.1.2s0 .1.1.1c0 .1.1.3.1.4v40l15.6-9V22.9c0-.1 0-.3.1-.4 0 0 0-.1.1-.1 0-.1.1-.2.1-.2 0-.1.1-.1.1-.1 0-.1.1-.1.1-.2 0 0 .1-.1.2-.1s.1-.1.2-.1l18.7-10.8c.2-.1.5-.2.8-.2s.5.1.8.2l18.7 10.8c.1 0 .1.1.2.1l.1.1c.1.1.1.1.1.2l.1.1c0 .1.1.2.1.2-.2 0-.2 0-.2.1m-3.1 20.8V25.6l-6.5 3.8-9 5.2v17.7zM76.7 75.4V57.7l-8.9 5.1-25.3 14.4v17.9zM5.1 15v60.4l34.3 19.7V77.2L21.5 67.1c-.1 0-.1-.1-.2-.1l-.1-.1c-.1 0-.1-.1-.1-.2s-.1-.1-.1-.2-.1-.1-.1-.2-.1-.1-.1-.2V24l-9-5.2zM22.2 3.4l-15.6 9 15.6 9 15.6-9zm8.1 55.9 9-5.2V15l-6.5 3.8-9 5.2v39zm48-45.4-15.6 9 15.6 9 15.6-9zm-1.6 20.7-9-5.2-6.5-3.8v17.7l9 5.2 6.5 3.8zM40.9 74.5l22.8-13L75.2 55l-15.6-9-17.9 10.3-16.3 9.4z"/></svg>
                    </span>
                    <span class="icon-hover">
    ...
    <p class="section-title">
        <span class="light">EXPER</span><span class="bold">IENCE</span>
    </p>
    <div id="experience" class="experience-container reveal">

        <div class="experience-timeline">
            {{-- Entry 1 - LEFT --}}
            <div class="exp-entry exp-left">
                <div class="exp-dot"></div>
                <div class="exp-content">
                    <div class="exp-text">
                        <h3 class="exp-title">Web Developer Intern | <span class="exp-company">Magellan Solutions</span></h3>
                        <p class="exp-subtitle">Focus: Backend Architecture & Laravel Systems</p>
                        <p class="exp-desc">I'm <span class="name-red">Lanz</span>, a fresh graduate focused on backend development. I enjoy building structured, efficient systems and working with databases, logic, and server-side processes. I like creating clean and reliable code that supports smooth and functional applications. I believe good development is organized, purposeful, and works effectively behind the scenes without unnecessary complexity.</p>
                    </div>
                    <!-- <div class="exp-image">
                        <img src="img/exp_pic1.jpg" alt="Experience photo 1">
                        <img src="img/exp_pic2.jpg" alt="Experience photo 2">
                    </div> -->
                </div>
            </div>

            {{-- Entry 2 - RIGHT --}}
            <div class="exp-entry exp-right">
                <div class="exp-dot"></div>
                <div class="exp-content">
                    <div class="exp-text">
                        <div class="exp-title-row">
                            <h3 class="exp-title">Bachelor of Science in Information Technology</h3>
                            <!-- <span class="exp-year">2022 – 2026</span> -->
                        </div>
                        <p class="exp-subtitle">Bulacan State University – Bustos Campus &nbsp; | &nbsp; 2022 - 2026</p>
                        <p class="exp-desc">I'm <span class="name-red">Lanz</span>, a fresh graduate focused on backend development. I enjoy building structured, efficient systems and working with databases, logic, and server-side processes. I like creating clean and reliable code that supports smooth and functional applications. I believe good development is organized, purposeful, and works effectively behind the scenes without unnecessary complexity.</p>
                    </div>
                </div>
            </div>
